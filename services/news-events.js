...
const fallbackNews = [
  {
    ...
    description:
      "Hyderabad: Season after season, misery after misery is plaguing the farmers of Telangana.\n\nFrom inordinate delays in the",
  ...
  },
  {
    ...
    image:
      "/files/Telangana-govt-to-provide-Rs-10k-per-acre-as-aid-for-crop-damage.webp",
    description:
      "Hyderabad: The Congress govt has decided to pay 10,000 per a ..\n\nRead more at:\nhttp://timesofindia.indiatimes.com/articleshow/120238025.cms?utm_source=contentofinterest&utm_medium=text&utm_campaign=cppst",
...
async function fetchNews() {
  try {
    const response = await fetch(
      'https://erp-ryss.ap.gov.in/api/resource/News?fields=["name","title","image","description","datetime"]',
    );
...
const fallbackEvents = [
  {
    ...
    title: "Event 22",
    description:
      "Lorem ipsum is a dummy text that serves as a placeholder for actual content. It's used to visualize the layout and design elements of a document or website without having to rely on real text. ",
  ...
  },
  {
    ...
    title: "Dance ",
    description:
      "This is important for both boys and girls as it  is very important for fitness and all the things",
  ...
  },
  {
    ...
    title: "sports event",
    description:
      "This is for the development of sports and fitness of the students.Everybody should take part in this event as iyt is very important for personal fitnes",
  ...
  },
  {
    ...
    title: "demo",
    description:
      "Every body should take care of himself and at the same time enjoy every moment of his life.",
...
async function fetchEvents() {
  try {
    const response = await fetch(
      'https://erp-ryss.ap.gov.in/api/resource/Events?fields=["name","title","description","datetime"]',
    );
    if (!response.ok) throw new Error("API fetch failed");
    const json = await response.json();
