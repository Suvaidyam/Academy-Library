...
export async function getandSetDyanamicCourseDetailsAndName() {
    ...
    let ugCourseContent = 'The Academy is currently offering one course under this program. The under graduation course is delivered through experiential learning. This program includes classroom sessions, field classes, online classes, and field practice with strong emphasis on learning by doing. The graduation course follows a multiple entry-exit policy, allowing students to exit after each year, if necessary, and continue the course later through earned credits.​'
    ...
    let CertificationContent = 'The Academy is currently offering one course under this program. The under graduation course is delivered through experiential learning. This program includes classroom sessions, field classes, online classes, and field practice with strong emphasis on learning by doing. The graduation course follows a multiple entry-exit policy, allowing students to exit after each year, if necessary, and continue the course later through earned credits.​'
