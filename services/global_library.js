...
function displayArtifacts() {
  ...
  artifacts.forEach((post) => {
    ...
    newCard.querySelector(".post-author").textContent =
      post.internalauthor || post.author || "Unknown";
    newCard.querySelector(".post-date time").textContent =
  ...
  if (currentPage > 1) {
    ...
    if (activeTab === "Subscribed") {
      ...
      if (
        ...
        handlelanguageDropdown.value !== "Language"
      ) {
                        ...
                        ${
                          element.title
                            ...
                            : element.a_short_description_about_the_artifact
                              ? element.a_short_description_about_the_artifact
                                  .length > 50
                                ? element.a_short_description_about_the_artifact.slice(
                                    0,
                                    50,
                                  ) + "..."
                                : element.a_short_description_about_the_artifact
...
handlelanguageDropdown.addEventListener("change", async (event) => {
  ...
  if (activeTab === "Subscribed") {
    ...
    const Externaldata = await fetchAllData({
      source: "External",
      language: selectedLanguage,
    });
    fullData.push(...Externaldata);
